...
class LoginForm(forms.Form):
    ...
    error_messages = {
        'account_inactive':
        _("На данный момент, этот аккаунт деактивирован."),
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            login_widget = forms.TextInput(attrs={'type': 'email',
                                                  ...
                                                  _('Электронная почта'),
                                                  'autofocus': 'autofocus'})
            login_field = forms.EmailField(label=_("Электронная почта"),
                                           widget=login_widget)
            ...
            login_widget = forms.TextInput(attrs={'placeholder':
                                                  _('Имя пользователя или эл. адрес'),
                                                  'autofocus': 'autofocus'})
